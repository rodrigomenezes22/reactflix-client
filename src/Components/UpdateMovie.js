...
function UppdateMovie() {
    ...
    const { id } = useParams();
    const [ movie, setMovie ] = useState({ title: "", director: "", year: "", rating: "", genre: "", poster: "", movie_duration: ""})
                ...
                <div className='col-6 videos-form-wrapper p-5'>
                    ...
                    <form className="row g-3  mb-5" onSubmit={handleSubmit}>
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="number" className="form-control" id="year" name="year" value={movie.year} onChange={handleChange} />
                        </div>
                        <div className="col-12">
                            <label for="inputAddress" className="form-label">Director</label>
                            <input type="text" className="form-control" name="director" id="director" placeholder="Director name" value={movie.director} onChange={handleChange} />
                        </div>
                        <div className="col-12">
                            <label for="inputAddress2" className="form-label">Genre</label>
                            <input type="text" className="form-control" id="genre" name='genre' placeholder="Genre, Comedy, TV Series, etc" value={movie.genre} onChange={handleChange} />
                        </div>

                        <div className="col-md-6">
                            <label for="inputEmail4" className="form-label">Movie Duration</label>
                            <input type="text" className="form-control" id="movie_duration" name="movie_duration" value={movie.movie_duration} onChange={handleChange} />
                        </div>
                        <div className="col-md-6">
                            <label for="inputPassword4" className="form-label">Rating</label>
                            <input type="number" className="form-control" id="rating" name="rating" value={movie.rating} onChange={handleChange} />
                        </div>
                        <div className="col-12">
